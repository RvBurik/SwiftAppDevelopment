...
//    Start of binding stack views
    @IBOutlet weak var singleStackView: UIStackView!
    @IBOutlet weak var multipleStackView: UIStackView!
    @IBOutlet weak var rangedStackView: UIStackView!
    
// Start of binding buttons on singlestackview
...
//    Start of binding labels on multistackview
    @IBOutlet weak var multiLabel1: UILabel!
    @IBOutlet weak var multiLabel2: UILabel!
    @IBOutlet weak var multiLabel3: UILabel!
    @IBOutlet weak var multiLabel4: UILabel!
    
//    Start of binding labels on rangedstackview
    ...
    func updateUI(){
        ...
        case .multiple:
            updateMultiStackView(using: currentAnswers)
        case .ranged:
    ...
    func updateMultiStackView(using answers: [Answer]){
    ...
    @IBAction func rangedAnswerSliderSet(){
        let currentAnswers = questions[questionIndex].answers
